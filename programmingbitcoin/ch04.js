...
console.log('base58', pub.encode_base58(Buffer.from('000000abcd1234','hex')).toString()) // random but verified against python code

const dsha = pub.double_sha256(Buffer.from('', 'hex'))
console.log('double sha256', dsha.toString('hex')) // the reverse of this is tx hash

console.log('base58chk', pub.encode_base58_checksum(Buffer.from('abcd1234','hex')).toString())

console.log('address', pub.address().toString())
